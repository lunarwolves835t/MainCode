...
class general{
  ...
  ///moves forward six inches
  void sixer(){
    ///calls all motors forward
    ;
  }
  ...
  void turnDir(int dir){ ///takes a direction of 1 or -1 for right or left
    ///calls motors with a speed multiplied by dir
    ;
  }
